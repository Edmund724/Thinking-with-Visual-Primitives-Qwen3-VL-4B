...
class TestPretrainDataFormat:
    ...
    def test_tags_paired(self):
        ...
        for sample in data:
            user = sample["conversations"][0]["content"]
            assistant = sample["conversations"][1]["content"]
            assert _validate_tags(user + " " + assistant), \
                f"Unpaired tags in: {assistant[:60]}..."
    ...
    def test_output_file_format(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            for item in loaded:
                ...
                assert item["conversations"][0]["role"] == "user"
                assert item["conversations"][1]["role"] == "assistant"
